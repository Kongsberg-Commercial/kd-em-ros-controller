...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__create(void)
{
  ...
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request * msg = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request));
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__init(msg);
  if (!success) {
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__init(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request * data = NULL;

  if (size) {
    data = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request *)allocator.zero_allocate(size, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__fini(&data[i - 1]);
      }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__fini(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * array = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__init(array, size);
  if (!success) {
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__destroy(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__are_equal(const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * lhs, const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request * data =
      (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__copy(
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__init(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response * msg = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response));
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__init(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response * data = NULL;

  if (size) {
    data = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response *)allocator.zero_allocate(size, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__fini(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * array = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__destroy(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__are_equal(const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * lhs, const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response * data =
      (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__init(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(msg);
    return false;
  }
  // request
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__init(&msg->request, 0)) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(msg);
    return false;
  }
  // response
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__init(&msg->response, 0)) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(msg);
    return false;
  }
  return true;
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * msg)
{
  ...
  // request
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__fini(&msg->request);
  // response
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__fini(&msg->response);
}
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__are_equal(const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * lhs, const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * rhs)
{
  ...
  // request
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__are_equal(
  ...
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * output)
{
  ...
  // request
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * msg = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event));
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__init(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * data = NULL;

  if (size) {
    data = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event *)allocator.zero_allocate(size, sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__fini(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * array = (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence *)allocator.allocate(sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__destroy(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence__are_equal(const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * lhs, const ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event * data =
      (ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_kctrl_custom_interfaces__srv__RequestPUParameters_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
