...
#include <fstream>
#include <sstream>
#include "ros2_kctrl_custom_interfaces/srv/sounder_command.hpp"
#include "ros2_kctrl_custom_interfaces/srv/request_pu_parameters.hpp"
#include "ros2_kctrl_interface_pkg/ros2ctrl_udp_client.hpp"
#include "ros2_kctrl_interface_pkg/simple_udp.hpp"
#include "ros2_kctrl_custom_interfaces/srv/set_pu_parameters.hpp"
#include "ros2_kctrl_custom_interfaces/srv/recording_control.hpp"
#include "ros2_kctrl_custom_interfaces/srv/update_recording_path.hpp"
#include "ros2_kctrl_custom_interfaces/srv/pu_parameters.hpp"
#include "ros2_kctrl_custom_interfaces/srv/request_detected_sounders.hpp"
...
public:
    Ros2CtrlWrapperNode() : Node("ros2_ctrl_wrapper_node") {
        ...
        start_sounder_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/start_sounder",
            std::bind(&Ros2CtrlWrapperNode::startSounderCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        start_pinging_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/start_pinging",
            std::bind(&Ros2CtrlWrapperNode::startPingingCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        stop_pinging_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/stop_pinging",
            std::bind(&Ros2CtrlWrapperNode::stopPingingCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        start_water_column_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
        ...
        stop_water_column_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/stop_water_column",
            std::bind(&Ros2CtrlWrapperNode::stopWaterColumnCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        start_stave_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/start_stave",
            std::bind(&Ros2CtrlWrapperNode::startStaveCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        stop_stave_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/stop_stave",
            std::bind(&Ros2CtrlWrapperNode::stopStaveCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        shutdown_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
            "kctrl/shutdown",
            std::bind(&Ros2CtrlWrapperNode::shutdownCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        request_pu_parameters_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::RequestPUParameters>(
        ...
        set_pu_parameters_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SetPUParameters>(
            "kctrl/set_pu_parameters",
            std::bind(&Ros2CtrlWrapperNode::setPUParametersCallback, this, std::placeholders::_1, std::placeholders::_2)
        );
        request_install_runtime_parameters_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
        ...
        request_multicast_address_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
        ...
        recording_control_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::RecordingControl>(
        ...
        update_recording_path_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::UpdateRecordingPath>(
        ...
        disconnect_sounder_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::SounderCommand>(
        ...
        export_pu_parameters_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::PUParameters>(
        ...
        request_detected_sounders_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::RequestDetectedSounders>(
        ...
        import_pu_parameters_srv_ = this->create_service<ros2_kctrl_custom_interfaces::srv::PUParameters>(
...
private:
    void startSounderCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::SounderCommand::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::SounderCommand::Response> res)
    {
    ...
    void requestPUParametersCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RequestPUParameters::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RequestPUParameters::Response> res)
    {
    ...
    void setPUParametersCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::SetPUParameters::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::SetPUParameters::Response> res)
    {
    ...
    void recordingControlCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RecordingControl::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RecordingControl::Response> res)
    {
    ...
    void updateRecordingPathCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::UpdateRecordingPath::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::UpdateRecordingPath::Response> res)
    {
    ...
    void exportPUParametersCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::PUParameters::Request> req,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::PUParameters::Response> res)
    {
    ...
    void requestDetectedSoundersCallback(
        const std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RequestDetectedSounders::Request> /*req*/,
        std::shared_ptr<ros2_kctrl_custom_interfaces::srv::RequestDetectedSounders::Response> res)
    {
    ...
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr start_sounder_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr start_pinging_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr stop_pinging_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr start_water_column_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr stop_water_column_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr start_stave_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr stop_stave_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr shutdown_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::RequestPUParameters>::SharedPtr request_pu_parameters_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SetPUParameters>::SharedPtr set_pu_parameters_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr request_install_runtime_parameters_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr request_multicast_address_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::RecordingControl>::SharedPtr recording_control_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::UpdateRecordingPath>::SharedPtr update_recording_path_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::SounderCommand>::SharedPtr disconnect_sounder_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::PUParameters>::SharedPtr export_pu_parameters_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::RequestDetectedSounders>::SharedPtr request_detected_sounders_srv_;
    rclcpp::Service<ros2_kctrl_custom_interfaces::srv::PUParameters>::SharedPtr import_pu_parameters_srv_;
