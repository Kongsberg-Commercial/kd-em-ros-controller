...
: Node("ros2_udp_receiver"), running_(true)
{
    ...
    pub_version_      = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlVersion>("kctrl/version", 10);
    pub_version_raw_  = this->create_publisher<std_msgs::msg::String>("kctrl/version_raw", 10);

    pub_devices_      = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlDetectedDevices>("kctrl/detected_devices", 10);
    pub_devices_raw_  = this->create_publisher<std_msgs::msg::String>("kctrl/detected_devices_raw", 10);

    pub_param_        = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlParameters>("kctrl/parameters", 10);
    pub_param_raw_    = this->create_publisher<std_msgs::msg::String>("kctrl/parameters_raw", 10);

    pub_multicast_    = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlMulticast>("kctrl/multicast", 10);
    pub_multicast_raw_= this->create_publisher<std_msgs::msg::String>("kctrl/multicast_raw", 10);

    pub_status_       = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlStatus>("kctrl/status", 10);
    pub_status_raw_   = this->create_publisher<std_msgs::msg::String>("kctrl/status_raw", 10);

    pub_info_warn_error_ = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlInfoWarnError>("kctrl/info_warn_error", 10);
    pub_info_warn_error_raw_ = this->create_publisher<std_msgs::msg::String>("kctrl/info_warn_error_raw", 10);

    pub_device_disconnected_ = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlDeviceDisconnected>("kctrl/device_disconnected", 10);
    pub_device_disconnected_raw_ = this->create_publisher<std_msgs::msg::String>("kctrl/device_disconnected_raw", 10);

    pub_pu_params_ = this->create_publisher<ros2_kctrl_custom_interfaces::msg::KctrlPUParams>("kctrl/pu_params", 10);
...
void Ros2UdpReceiver::handle_kssis_1(const std::string& msg) {
    ...
    auto version_msg = ros2_kctrl_custom_interfaces::msg::KctrlVersion();
...
void Ros2UdpReceiver::handle_kssis_12(const std::string& msg) {
    ...
    auto devices_msg = ros2_kctrl_custom_interfaces::msg::KctrlDetectedDevices();
...
void Ros2UdpReceiver::handle_kssis_401(const std::string& msg) {
    ...
    if (start == std::string::npos || end == std::string::npos || end <= start) {
        auto param_msg = ros2_kctrl_custom_interfaces::msg::KctrlParameters();
    ...
    try {
        ...
        for (const auto& param : j) {
            auto kctrl_param = ros2_kctrl_custom_interfaces::msg::KctrlParameter();
...
void Ros2UdpReceiver::handle_kssis_455(const std::string& msg) {
    ...
    auto multicast_msg = ros2_kctrl_custom_interfaces::msg::KctrlMulticast();
    if (parts.size() >= 5) {
...
void Ros2UdpReceiver::handle_kssis_616(const std::string& msg) {
    ...
    if (start == std::string::npos) {
        auto status_msg = ros2_kctrl_custom_interfaces::msg::KctrlStatus();
    ...
    while (std::getline(ss, token, ',')) {
        ...
        if (eq != std::string::npos) {
            ...
            auto status_entry = ros2_kctrl_custom_interfaces::msg::KctrlStatusEntry();
...
void Ros2UdpReceiver::handle_kssis_499(const std::string& msg) {
    ...
    auto info_msg = ros2_kctrl_custom_interfaces::msg::KctrlInfoWarnError();
...
void Ros2UdpReceiver::handle_kssis_998(const std::string& msg) {
    ...
    auto disconnect_msg = ros2_kctrl_custom_interfaces::msg::KctrlDeviceDisconnected();
...
void Ros2UdpReceiver::handle_kssis_993(const std::string& msg) {
    ...
    std::string xml_file_path = "/home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/include/pu_params.xml"; // Change path as needed
    ...
    auto pu_params_msg = ros2_kctrl_custom_interfaces::msg::KctrlPUParams();
...
std::vector<ros2_kctrl_custom_interfaces::msg::KctrlDevice> Ros2UdpReceiver::parse_devices(const std::string& msg) {
    std::vector<ros2_kctrl_custom_interfaces::msg::KctrlDevice> devices;
    ...
    for (const auto& deviceEntry : deviceEntries) {
        ...
        auto device = ros2_kctrl_custom_interfaces::msg::KctrlDevice();
