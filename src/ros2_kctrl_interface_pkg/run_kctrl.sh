...
case $choice in
    ...
    2)
        ...
        ;;
    3)
        echo "Using config file: /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml"
        if [ -f "/home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml" ]; then
            ros2 launch ros2_kctrl_interface_pkg ros2_ctrl.launch.py \
                config_file:=/home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml
        else
    ...
    5)
        ...
        if [ -f "/home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml" ]; then
            ${EDITOR:-nano} /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml
            echo "Config file updated. Run this script again to use the new settings."
        else
            echo "Config file not found. Creating a new one..."
            mkdir -p /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config
            cp install/ros2_kctrl_interface_pkg/share/ros2_kctrl_interface_pkg/config/kctrl_config.yaml /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml 2>/dev/null || echo "# Create your config file here" > /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml
            ${EDITOR:-nano} /home/arveds/ros2_ws/src/ros2_kctrl_interface_pkg/config/kctrl_config.yaml
        fi
        ;;
    *)
