...
These are included in the workspace as `ros2_kctrl_custom_interfaces`.  
...
3. **(Optional) Source the alias file for easier usage:**
   ```bash
   source /home/<user>/ros2_ws/src/ros2_kctrl_interface_pkg/ros2_kctrl_aliases.sh
   ```
...
[`ros2_kctrl_aliases.sh`](./ros2_kctrl_aliases.sh)
...
2. **Available Aliases (examples):**
   ...
   *(See the [alias file](./ros2_kctrl_aliases.sh) or `Lists/ros2_kctrl_bash_commands.md` for the full list and details.)*
