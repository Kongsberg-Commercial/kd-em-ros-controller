...
declare module 'rclnodejs' {
  ...
  namespace pcl_msgs {
    ...
    namespace srv {
      ...
      export interface UpdateFilename_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: pcl_msgs.srv.UpdateFilename_Request[];
        response: pcl_msgs.srv.UpdateFilename_Response[];
      }
      export interface UpdateFilename_EventConstructor {
        new(other?: UpdateFilename_Event): UpdateFilename_Event;
      }
  ...
  namespace ros_kctrl_custom_interfaces {
    namespace msg {
      export interface KctrlDetectedDevices {
        devices: ros_kctrl_custom_interfaces.msg.KctrlDevice[];
      }
      export interface KctrlDetectedDevicesConstructor {
        new(other?: KctrlDetectedDevices): KctrlDetectedDevices;
      }
      export interface KctrlDevice {
        name: string;
        ip: string;
        type: string;
        system_id: string;
        started: string;
        is_pinging: string;
        data_macst_ip: string;
        data_macst_port: string;
        cmdport_port: string;
        system_desc: string;
        license: string;
      }
      export interface KctrlDeviceConstructor {
        new(other?: KctrlDevice): KctrlDevice;
      }
      export interface KctrlDeviceDisconnected {
        device: string;
      }
      export interface KctrlDeviceDisconnectedConstructor {
        new(other?: KctrlDeviceDisconnected): KctrlDeviceDisconnected;
      }
      export interface KctrlInfoWarnError {
        device: string;
        timestamp: string;
        level: string;
        text: string;
      }
      export interface KctrlInfoWarnErrorConstructor {
        new(other?: KctrlInfoWarnError): KctrlInfoWarnError;
      }
      export interface KctrlMulticast {
        sounder: string;
        multicast_addr: string;
        multicast_port: string;
      }
      export interface KctrlMulticastConstructor {
        new(other?: KctrlMulticast): KctrlMulticast;
      }
      export interface KctrlPUParams {
        device: string;
        xml: string;
      }
      export interface KctrlPUParamsConstructor {
        new(other?: KctrlPUParams): KctrlPUParams;
      }
      export interface KctrlParameter {
        name: string;
        value: string;
      }
      export interface KctrlParameterConstructor {
        new(other?: KctrlParameter): KctrlParameter;
      }
      export interface KctrlParameters {
        parameters: ros_kctrl_custom_interfaces.msg.KctrlParameter[];
      }
      export interface KctrlParametersConstructor {
        new(other?: KctrlParameters): KctrlParameters;
      }
      export interface KctrlStatus {
        entries: ros_kctrl_custom_interfaces.msg.KctrlStatusEntry[];
      }
      export interface KctrlStatusConstructor {
        new(other?: KctrlStatus): KctrlStatus;
      }
      export interface KctrlStatusEntry {
        key: string;
        value: string;
      }
      export interface KctrlStatusEntryConstructor {
        new(other?: KctrlStatusEntry): KctrlStatusEntry;
      }
      export interface KctrlVersion {
        version: string;
      }
      export interface KctrlVersionConstructor {
        new(other?: KctrlVersion): KctrlVersion;
      }
      namespace descriptor {
        export interface KctrlDetectedDevices {
          devices: 'ros_kctrl_custom_interfaces/msg/KctrlDevice[]';
    ...
    namespace srv {
      export interface PUParametersConstructor extends ROSService {
        readonly Request: PUParameters_RequestConstructor;
        readonly Response: PUParameters_ResponseConstructor;
      }
      export interface PUParameters_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.PUParameters_Request[];
        response: ros_kctrl_custom_interfaces.srv.PUParameters_Response[];
      }
      export interface PUParameters_EventConstructor {
        new(other?: PUParameters_Event): PUParameters_Event;
      }
      export interface PUParameters_Request {
        sounder_name: string;
        file_name: string;
      }
      export interface PUParameters_RequestConstructor {
        new(other?: PUParameters_Request): PUParameters_Request;
      }
      export interface PUParameters_Response {
        success: boolean;
        message: string;
      }
      export interface PUParameters_ResponseConstructor {
        new(other?: PUParameters_Response): PUParameters_Response;
      }
      export interface RecordingControlConstructor extends ROSService {
        readonly Request: RecordingControl_RequestConstructor;
        readonly Response: RecordingControl_ResponseConstructor;
      }
      export interface RecordingControl_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.RecordingControl_Request[];
        response: ros_kctrl_custom_interfaces.srv.RecordingControl_Response[];
      }
      export interface RecordingControl_EventConstructor {
        new(other?: RecordingControl_Event): RecordingControl_Event;
      }
      export interface RecordingControl_Request {
        sounder_name: string;
        turn_on: boolean;
      }
      export interface RecordingControl_RequestConstructor {
        new(other?: RecordingControl_Request): RecordingControl_Request;
      }
      export interface RecordingControl_Response {
        success: boolean;
        message: string;
      }
      export interface RecordingControl_ResponseConstructor {
        new(other?: RecordingControl_Response): RecordingControl_Response;
      }
      export interface RequestDetectedSoundersConstructor extends ROSService {
        readonly Request: RequestDetectedSounders_RequestConstructor;
        readonly Response: RequestDetectedSounders_ResponseConstructor;
      }
      export interface RequestDetectedSounders_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_Request[];
        response: ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_Response[];
      }
      export interface RequestDetectedSounders_EventConstructor {
        new(other?: RequestDetectedSounders_Event): RequestDetectedSounders_Event;
      }
      export interface RequestDetectedSounders_Request {
      }
      export interface RequestDetectedSounders_RequestConstructor {
        new(other?: RequestDetectedSounders_Request): RequestDetectedSounders_Request;
      }
      export interface RequestDetectedSounders_Response {
        success: boolean;
        message: string;
      }
      export interface RequestDetectedSounders_ResponseConstructor {
        new(other?: RequestDetectedSounders_Response): RequestDetectedSounders_Response;
      }
      export interface RequestPUParametersConstructor extends ROSService {
        readonly Request: RequestPUParameters_RequestConstructor;
        readonly Response: RequestPUParameters_ResponseConstructor;
      }
      export interface RequestPUParameters_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.RequestPUParameters_Request[];
        response: ros_kctrl_custom_interfaces.srv.RequestPUParameters_Response[];
      }
      export interface RequestPUParameters_EventConstructor {
        new(other?: RequestPUParameters_Event): RequestPUParameters_Event;
      }
      export interface RequestPUParameters_Request {
        sounder_name: string;
        param_names: string[];
      }
      export interface RequestPUParameters_RequestConstructor {
        new(other?: RequestPUParameters_Request): RequestPUParameters_Request;
      }
      export interface RequestPUParameters_Response {
        success: boolean;
        message: string;
      }
      export interface RequestPUParameters_ResponseConstructor {
        new(other?: RequestPUParameters_Response): RequestPUParameters_Response;
      }
      export interface SetPUParametersConstructor extends ROSService {
        readonly Request: SetPUParameters_RequestConstructor;
        readonly Response: SetPUParameters_ResponseConstructor;
      }
      export interface SetPUParameters_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.SetPUParameters_Request[];
        response: ros_kctrl_custom_interfaces.srv.SetPUParameters_Response[];
      }
      export interface SetPUParameters_EventConstructor {
        new(other?: SetPUParameters_Event): SetPUParameters_Event;
      }
      export interface SetPUParameters_Request {
        sounder_name: string;
        param_names: string[];
        param_values: string[];
      }
      export interface SetPUParameters_RequestConstructor {
        new(other?: SetPUParameters_Request): SetPUParameters_Request;
      }
      export interface SetPUParameters_Response {
        success: boolean;
        message: string;
      }
      export interface SetPUParameters_ResponseConstructor {
        new(other?: SetPUParameters_Response): SetPUParameters_Response;
      }
      export interface SounderCommandConstructor extends ROSService {
        readonly Request: SounderCommand_RequestConstructor;
        readonly Response: SounderCommand_ResponseConstructor;
      }
      export interface SounderCommand_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.SounderCommand_Request[];
        response: ros_kctrl_custom_interfaces.srv.SounderCommand_Response[];
      }
      export interface SounderCommand_EventConstructor {
        new(other?: SounderCommand_Event): SounderCommand_Event;
      }
      export interface SounderCommand_Request {
        sounder_name: string;
      }
      export interface SounderCommand_RequestConstructor {
        new(other?: SounderCommand_Request): SounderCommand_Request;
      }
      export interface SounderCommand_Response {
        success: boolean;
        message: string;
      }
      export interface SounderCommand_ResponseConstructor {
        new(other?: SounderCommand_Response): SounderCommand_Response;
      }
      export interface UpdateRecordingPathConstructor extends ROSService {
        readonly Request: UpdateRecordingPath_RequestConstructor;
        readonly Response: UpdateRecordingPath_ResponseConstructor;
      }
      export interface UpdateRecordingPath_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_Request[];
        response: ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_Response[];
      }
      export interface UpdateRecordingPath_EventConstructor {
        new(other?: UpdateRecordingPath_Event): UpdateRecordingPath_Event;
      }
      export interface UpdateRecordingPath_Request {
        sounder_name: string;
        folder_path: string;
      }
      export interface UpdateRecordingPath_RequestConstructor {
        new(other?: UpdateRecordingPath_Request): UpdateRecordingPath_Request;
      }
      export interface UpdateRecordingPath_Response {
        success: boolean;
        message: string;
      }
      export interface UpdateRecordingPath_ResponseConstructor {
        new(other?: UpdateRecordingPath_Response): UpdateRecordingPath_Response;
      }
      namespace descriptor {
        export interface PUParametersConstructor extends ROSService {
          readonly Request: PUParameters_RequestConstructor;
  ...
  namespace ros_otter_custom_interfaces {
    namespace msg {
      export interface ErrorInfo {
        description: string;
      }
      export interface ErrorInfoConstructor {
        new(other?: ErrorInfo): ErrorInfo;
      }
      ...
      export interface GpsInfoConstructor {
        new(other?: GpsInfo): GpsInfo;
      }
      ...
      export interface Leg {
        start: ros_otter_custom_interfaces.msg.Vertex;
        end: ros_otter_custom_interfaces.msg.Vertex;
      }
      export interface LegConstructor {
        new(other?: Leg): Leg;
      }
      ...
      export interface ModeInfoConstructor {
        new(other?: ModeInfo): ModeInfo;
      }
      export interface OtterInfo {
        rpm_port: number;
        rpm_stb: number;
        temp_port: number;
        temp_stb: number;
      ...
      export interface OtterInfoConstructor {
        new(other?: OtterInfo): OtterInfo;
      }
      export interface Paths {
        paths: ros_otter_custom_interfaces.msg.Leg[];
      }
      export interface PathsConstructor {
        new(other?: Paths): Paths;
      }
      export interface ShadowAnalysis {
        header: std_msgs.msg.Header;
        leg_id: string;
        total_cells_analyzed: number;
        shadow_cells_detected: number;
        mean_point_density: number;
        grid_cell_size: number;
        density_threshold: number;
        shadow_cells: ros_otter_custom_interfaces.msg.ShadowCell[];
      }
      export interface ShadowAnalysisConstructor {
        new(other?: ShadowAnalysis): ShadowAnalysis;
      }
      export interface ShadowCell {
        ...
        detection_time: builtin_interfaces.msg.Time;
        leg_id: string;
      }
      export interface ShadowCellConstructor {
        new(other?: ShadowCell): ShadowCell;
      }
      export interface SurveyInfo {
        vertices: ros_otter_custom_interfaces.msg.Vertex[];
        start: ros_otter_custom_interfaces.msg.Vertex;
      }
      export interface SurveyInfoConstructor {
        new(other?: SurveyInfo): SurveyInfo;
      }
      export interface SwathLineStats {
        min_swath_width: number;
        max_swath_width: number;
        avg_swath_width: number;
        min_depth: number;
        max_depth: number;
        avg_depth: number;
      }
      export interface SwathLineStatsConstructor {
        new(other?: SwathLineStats): SwathLineStats;
      }
      ...
      namespace descriptor {
        ...
        export interface ShadowAnalysis {
          header: 'std_msgs/msg/Header';
          leg_id: 'string';
          total_cells_analyzed: 'int32';
          shadow_cells_detected: 'int32';
          mean_point_density: 'float64';
          grid_cell_size: 'float64';
        ...
        export interface SwathLineStats {
          min_swath_width: 'float64';
          max_swath_width: 'float64';
          avg_swath_width: 'float64';
          min_depth: 'float64';
          max_depth: 'float64';
          avg_depth: 'float64';
        }
    ...
    namespace srv {
      export interface CourseModeConstructor extends ROSService {
        readonly Request: CourseMode_RequestConstructor;
        readonly Response: CourseMode_ResponseConstructor;
      }
      export interface CourseMode_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.CourseMode_Request[];
        response: ros_otter_custom_interfaces.srv.CourseMode_Response[];
      }
      export interface CourseMode_EventConstructor {
        new(other?: CourseMode_Event): CourseMode_Event;
      }
      export interface CourseMode_Request {
        course: number;
        speed: number;
      }
      export interface CourseMode_RequestConstructor {
        new(other?: CourseMode_Request): CourseMode_Request;
      }
      export interface CourseMode_Response {
        success: boolean;
        message: string;
      }
      export interface CourseMode_ResponseConstructor {
        new(other?: CourseMode_Response): CourseMode_Response;
      }
      export interface DriftModeConstructor extends ROSService {
        readonly Request: DriftMode_RequestConstructor;
        readonly Response: DriftMode_ResponseConstructor;
      }
      export interface DriftMode_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.DriftMode_Request[];
        response: ros_otter_custom_interfaces.srv.DriftMode_Response[];
      }
      export interface DriftMode_EventConstructor {
        new(other?: DriftMode_Event): DriftMode_Event;
      }
      export interface DriftMode_Request {
      }
      export interface DriftMode_RequestConstructor {
        new(other?: DriftMode_Request): DriftMode_Request;
      }
      export interface DriftMode_Response {
        success: boolean;
        message: string;
      }
      export interface DriftMode_ResponseConstructor {
        new(other?: DriftMode_Response): DriftMode_Response;
      }
      export interface LegModeConstructor extends ROSService {
        readonly Request: LegMode_RequestConstructor;
        readonly Response: LegMode_ResponseConstructor;
      }
      export interface LegMode_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.LegMode_Request[];
        response: ros_otter_custom_interfaces.srv.LegMode_Response[];
      }
      export interface LegMode_EventConstructor {
        new(other?: LegMode_Event): LegMode_Event;
      }
      export interface LegMode_Request {
        leg_number: bigint;
      }
      export interface LegMode_RequestConstructor {
        new(other?: LegMode_Request): LegMode_Request;
      }
      export interface LegMode_Response {
        lat0: number;
        lat0_dir: string;
        lon0: number;
        lon0_dir: string;
      ...
      export interface LegMode_ResponseConstructor {
        new(other?: LegMode_Response): LegMode_Response;
      }
      export interface ManualModeConstructor extends ROSService {
        readonly Request: ManualMode_RequestConstructor;
        readonly Response: ManualMode_ResponseConstructor;
      }
      export interface ManualMode_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.ManualMode_Request[];
        response: ros_otter_custom_interfaces.srv.ManualMode_Response[];
      }
      export interface ManualMode_EventConstructor {
        new(other?: ManualMode_Event): ManualMode_Event;
      }
      export interface ManualMode_Request {
        force_x: number;
        force_y: number;
        torque_z: number;
      }
      export interface ManualMode_RequestConstructor {
        new(other?: ManualMode_Request): ManualMode_Request;
      }
      export interface ManualMode_Response {
        success: boolean;
        message: string;
      }
      export interface ManualMode_ResponseConstructor {
        new(other?: ManualMode_Response): ManualMode_Response;
      }
      export interface SetParametersConstructor extends ROSService {
        readonly Request: SetParameters_RequestConstructor;
        readonly Response: SetParameters_ResponseConstructor;
      ...
      export interface SetParameters_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.SetParameters_Request[];
        response: ros_otter_custom_interfaces.srv.SetParameters_Response[];
      }
      export interface SetParameters_EventConstructor {
        new(other?: SetParameters_Event): SetParameters_Event;
      }
      ...
      export interface StationModeConstructor extends ROSService {
        readonly Request: StationMode_RequestConstructor;
        readonly Response: StationMode_ResponseConstructor;
      }
      export interface StationMode_Event {
        info: service_msgs.msg.ServiceEventInfo;
        request: ros_otter_custom_interfaces.srv.StationMode_Request[];
        response: ros_otter_custom_interfaces.srv.StationMode_Response[];
      }
      export interface StationMode_EventConstructor {
        new(other?: StationMode_Event): StationMode_Event;
      }
      export interface StationMode_Request {
        lat: number;
        lat_dir: string;
        lon: number;
        lon_dir: string;
      ...
      export interface StationMode_RequestConstructor {
        new(other?: StationMode_Request): StationMode_Request;
      }
      export interface StationMode_Response {
        success: boolean;
        message: string;
      }
      export interface StationMode_ResponseConstructor {
        new(other?: StationMode_Response): StationMode_Response;
      }
      namespace descriptor {
        export interface CourseModeConstructor extends ROSService {
          readonly Request: CourseMode_RequestConstructor;
  ...
  type MessagesMap = {
    ...
    'geographic_msgs/msg/descriptor/BoundingBox': geographic_msgs.msg.descriptor.BoundingBox,
    'geographic_msgs/msg/descriptor/GeoPath': geographic_msgs.msg.descriptor.GeoPath,
    'geographic_msgs/msg/descriptor/GeoPoint': geographic_msgs.msg.descriptor.GeoPoint,
    'geographic_msgs/msg/descriptor/GeoPointStamped': geographic_msgs.msg.descriptor.GeoPointStamped,
    'geographic_msgs/msg/descriptor/GeoPose': geographic_msgs.msg.descriptor.GeoPose,
    'geographic_msgs/msg/descriptor/GeoPoseStamped': geographic_msgs.msg.descriptor.GeoPoseStamped,
    'geographic_msgs/msg/descriptor/GeoPoseWithCovariance': geographic_msgs.msg.descriptor.GeoPoseWithCovariance,
    'geographic_msgs/msg/descriptor/GeoPoseWithCovarianceStamped': geographic_msgs.msg.descriptor.GeoPoseWithCovarianceStamped,
    'geographic_msgs/msg/descriptor/GeographicMap': geographic_msgs.msg.descriptor.GeographicMap,
    'geographic_msgs/msg/descriptor/GeographicMapChanges': geographic_msgs.msg.descriptor.GeographicMapChanges,
    'geographic_msgs/msg/descriptor/KeyValue': geographic_msgs.msg.descriptor.KeyValue,
    'geographic_msgs/msg/descriptor/MapFeature': geographic_msgs.msg.descriptor.MapFeature,
    'geographic_msgs/msg/descriptor/RouteNetwork': geographic_msgs.msg.descriptor.RouteNetwork,
    'geographic_msgs/msg/descriptor/RoutePath': geographic_msgs.msg.descriptor.RoutePath,
    'geographic_msgs/msg/descriptor/RouteSegment': geographic_msgs.msg.descriptor.RouteSegment,
    'geographic_msgs/msg/descriptor/WayPoint': geographic_msgs.msg.descriptor.WayPoint,
    ...
    'geographic_msgs/srv/descriptor/GetGeoPath_Event': geographic_msgs.srv.descriptor.GetGeoPath_Event,
    'geographic_msgs/srv/descriptor/GetGeoPath_Request': geographic_msgs.srv.descriptor.GetGeoPath_Request,
    'geographic_msgs/srv/descriptor/GetGeoPath_Response': geographic_msgs.srv.descriptor.GetGeoPath_Response,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Event': geographic_msgs.srv.descriptor.GetGeographicMap_Event,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Request': geographic_msgs.srv.descriptor.GetGeographicMap_Request,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Response': geographic_msgs.srv.descriptor.GetGeographicMap_Response,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Event': geographic_msgs.srv.descriptor.GetRoutePlan_Event,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Request': geographic_msgs.srv.descriptor.GetRoutePlan_Request,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Response': geographic_msgs.srv.descriptor.GetRoutePlan_Response,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Event': geographic_msgs.srv.descriptor.UpdateGeographicMap_Event,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Request': geographic_msgs.srv.descriptor.UpdateGeographicMap_Request,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Response': geographic_msgs.srv.descriptor.UpdateGeographicMap_Response,
    ...
    'pcl_msgs/srv/UpdateFilename_Event': pcl_msgs.srv.UpdateFilename_Event,
    ...
    'pcl_msgs/srv/descriptor/UpdateFilename_Event': pcl_msgs.srv.descriptor.UpdateFilename_Event,
    ...
    'ros_kctrl_custom_interfaces/msg/KctrlDetectedDevices': ros_kctrl_custom_interfaces.msg.KctrlDetectedDevices,
    'ros_kctrl_custom_interfaces/msg/KctrlDevice': ros_kctrl_custom_interfaces.msg.KctrlDevice,
    'ros_kctrl_custom_interfaces/msg/KctrlDeviceDisconnected': ros_kctrl_custom_interfaces.msg.KctrlDeviceDisconnected,
    'ros_kctrl_custom_interfaces/msg/KctrlInfoWarnError': ros_kctrl_custom_interfaces.msg.KctrlInfoWarnError,
    'ros_kctrl_custom_interfaces/msg/KctrlMulticast': ros_kctrl_custom_interfaces.msg.KctrlMulticast,
    'ros_kctrl_custom_interfaces/msg/KctrlPUParams': ros_kctrl_custom_interfaces.msg.KctrlPUParams,
    'ros_kctrl_custom_interfaces/msg/KctrlParameter': ros_kctrl_custom_interfaces.msg.KctrlParameter,
    'ros_kctrl_custom_interfaces/msg/KctrlParameters': ros_kctrl_custom_interfaces.msg.KctrlParameters,
    'ros_kctrl_custom_interfaces/msg/KctrlStatus': ros_kctrl_custom_interfaces.msg.KctrlStatus,
    'ros_kctrl_custom_interfaces/msg/KctrlStatusEntry': ros_kctrl_custom_interfaces.msg.KctrlStatusEntry,
    'ros_kctrl_custom_interfaces/msg/KctrlVersion': ros_kctrl_custom_interfaces.msg.KctrlVersion,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDetectedDevices': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDetectedDevices,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDevice': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDevice,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDeviceDisconnected': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDeviceDisconnected,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlInfoWarnError': ros_kctrl_custom_interfaces.msg.descriptor.KctrlInfoWarnError,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlMulticast': ros_kctrl_custom_interfaces.msg.descriptor.KctrlMulticast,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlPUParams': ros_kctrl_custom_interfaces.msg.descriptor.KctrlPUParams,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlParameter': ros_kctrl_custom_interfaces.msg.descriptor.KctrlParameter,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlParameters': ros_kctrl_custom_interfaces.msg.descriptor.KctrlParameters,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlStatus': ros_kctrl_custom_interfaces.msg.descriptor.KctrlStatus,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlStatusEntry': ros_kctrl_custom_interfaces.msg.descriptor.KctrlStatusEntry,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlVersion': ros_kctrl_custom_interfaces.msg.descriptor.KctrlVersion,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Event': ros_kctrl_custom_interfaces.srv.PUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Request': ros_kctrl_custom_interfaces.srv.PUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Response': ros_kctrl_custom_interfaces.srv.PUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Event': ros_kctrl_custom_interfaces.srv.RecordingControl_Event,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Request': ros_kctrl_custom_interfaces.srv.RecordingControl_Request,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Response': ros_kctrl_custom_interfaces.srv.RecordingControl_Response,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Event': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_Event,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Request': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_Request,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Response': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_Response,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Event': ros_kctrl_custom_interfaces.srv.RequestPUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Request': ros_kctrl_custom_interfaces.srv.RequestPUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Response': ros_kctrl_custom_interfaces.srv.RequestPUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Event': ros_kctrl_custom_interfaces.srv.SetPUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Request': ros_kctrl_custom_interfaces.srv.SetPUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Response': ros_kctrl_custom_interfaces.srv.SetPUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Event': ros_kctrl_custom_interfaces.srv.SounderCommand_Event,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Request': ros_kctrl_custom_interfaces.srv.SounderCommand_Request,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Response': ros_kctrl_custom_interfaces.srv.SounderCommand_Response,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Event': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_Event,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Request': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_Request,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Response': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Event': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Request': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Response': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Event': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Request': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Response': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Event': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Request': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Response': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_Response,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Event': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_Event,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Request': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_Request,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Response': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_Response,
    'ros_otter_custom_interfaces/msg/ErrorInfo': ros_otter_custom_interfaces.msg.ErrorInfo,
    'ros_otter_custom_interfaces/msg/GpsInfo': ros_otter_custom_interfaces.msg.GpsInfo,
    'ros_otter_custom_interfaces/msg/ImuInfo': ros_otter_custom_interfaces.msg.ImuInfo,
    'ros_otter_custom_interfaces/msg/Leg': ros_otter_custom_interfaces.msg.Leg,
    'ros_otter_custom_interfaces/msg/ModeInfo': ros_otter_custom_interfaces.msg.ModeInfo,
    'ros_otter_custom_interfaces/msg/OtterInfo': ros_otter_custom_interfaces.msg.OtterInfo,
    'ros_otter_custom_interfaces/msg/Paths': ros_otter_custom_interfaces.msg.Paths,
    'ros_otter_custom_interfaces/msg/ShadowAnalysis': ros_otter_custom_interfaces.msg.ShadowAnalysis,
    'ros_otter_custom_interfaces/msg/ShadowCell': ros_otter_custom_interfaces.msg.ShadowCell,
    'ros_otter_custom_interfaces/msg/SurveyInfo': ros_otter_custom_interfaces.msg.SurveyInfo,
    'ros_otter_custom_interfaces/msg/SwathLineStats': ros_otter_custom_interfaces.msg.SwathLineStats,
    'ros_otter_custom_interfaces/msg/Vertex': ros_otter_custom_interfaces.msg.Vertex,
    'ros_otter_custom_interfaces/msg/descriptor/ErrorInfo': ros_otter_custom_interfaces.msg.descriptor.ErrorInfo,
    'ros_otter_custom_interfaces/msg/descriptor/GpsInfo': ros_otter_custom_interfaces.msg.descriptor.GpsInfo,
    'ros_otter_custom_interfaces/msg/descriptor/ImuInfo': ros_otter_custom_interfaces.msg.descriptor.ImuInfo,
    'ros_otter_custom_interfaces/msg/descriptor/Leg': ros_otter_custom_interfaces.msg.descriptor.Leg,
    'ros_otter_custom_interfaces/msg/descriptor/ModeInfo': ros_otter_custom_interfaces.msg.descriptor.ModeInfo,
    'ros_otter_custom_interfaces/msg/descriptor/OtterInfo': ros_otter_custom_interfaces.msg.descriptor.OtterInfo,
    'ros_otter_custom_interfaces/msg/descriptor/Paths': ros_otter_custom_interfaces.msg.descriptor.Paths,
    'ros_otter_custom_interfaces/msg/descriptor/ShadowAnalysis': ros_otter_custom_interfaces.msg.descriptor.ShadowAnalysis,
    'ros_otter_custom_interfaces/msg/descriptor/ShadowCell': ros_otter_custom_interfaces.msg.descriptor.ShadowCell,
    'ros_otter_custom_interfaces/msg/descriptor/SurveyInfo': ros_otter_custom_interfaces.msg.descriptor.SurveyInfo,
    'ros_otter_custom_interfaces/msg/descriptor/SwathLineStats': ros_otter_custom_interfaces.msg.descriptor.SwathLineStats,
    'ros_otter_custom_interfaces/msg/descriptor/Vertex': ros_otter_custom_interfaces.msg.descriptor.Vertex,
    'ros_otter_custom_interfaces/srv/CourseMode_Event': ros_otter_custom_interfaces.srv.CourseMode_Event,
    'ros_otter_custom_interfaces/srv/CourseMode_Request': ros_otter_custom_interfaces.srv.CourseMode_Request,
    'ros_otter_custom_interfaces/srv/CourseMode_Response': ros_otter_custom_interfaces.srv.CourseMode_Response,
    'ros_otter_custom_interfaces/srv/DriftMode_Event': ros_otter_custom_interfaces.srv.DriftMode_Event,
    'ros_otter_custom_interfaces/srv/DriftMode_Request': ros_otter_custom_interfaces.srv.DriftMode_Request,
    'ros_otter_custom_interfaces/srv/DriftMode_Response': ros_otter_custom_interfaces.srv.DriftMode_Response,
    'ros_otter_custom_interfaces/srv/LegMode_Event': ros_otter_custom_interfaces.srv.LegMode_Event,
    'ros_otter_custom_interfaces/srv/LegMode_Request': ros_otter_custom_interfaces.srv.LegMode_Request,
    'ros_otter_custom_interfaces/srv/LegMode_Response': ros_otter_custom_interfaces.srv.LegMode_Response,
    'ros_otter_custom_interfaces/srv/ManualMode_Event': ros_otter_custom_interfaces.srv.ManualMode_Event,
    'ros_otter_custom_interfaces/srv/ManualMode_Request': ros_otter_custom_interfaces.srv.ManualMode_Request,
    'ros_otter_custom_interfaces/srv/ManualMode_Response': ros_otter_custom_interfaces.srv.ManualMode_Response,
    'ros_otter_custom_interfaces/srv/SetParameters_Event': ros_otter_custom_interfaces.srv.SetParameters_Event,
    'ros_otter_custom_interfaces/srv/SetParameters_Request': ros_otter_custom_interfaces.srv.SetParameters_Request,
    'ros_otter_custom_interfaces/srv/SetParameters_Response': ros_otter_custom_interfaces.srv.SetParameters_Response,
    'ros_otter_custom_interfaces/srv/StationMode_Event': ros_otter_custom_interfaces.srv.StationMode_Event,
    'ros_otter_custom_interfaces/srv/StationMode_Request': ros_otter_custom_interfaces.srv.StationMode_Request,
    'ros_otter_custom_interfaces/srv/StationMode_Response': ros_otter_custom_interfaces.srv.StationMode_Response,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Event': ros_otter_custom_interfaces.srv.descriptor.CourseMode_Event,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Request': ros_otter_custom_interfaces.srv.descriptor.CourseMode_Request,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Response': ros_otter_custom_interfaces.srv.descriptor.CourseMode_Response,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Event': ros_otter_custom_interfaces.srv.descriptor.DriftMode_Event,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Request': ros_otter_custom_interfaces.srv.descriptor.DriftMode_Request,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Response': ros_otter_custom_interfaces.srv.descriptor.DriftMode_Response,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Event': ros_otter_custom_interfaces.srv.descriptor.LegMode_Event,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Request': ros_otter_custom_interfaces.srv.descriptor.LegMode_Request,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Response': ros_otter_custom_interfaces.srv.descriptor.LegMode_Response,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Event': ros_otter_custom_interfaces.srv.descriptor.ManualMode_Event,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Request': ros_otter_custom_interfaces.srv.descriptor.ManualMode_Request,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Response': ros_otter_custom_interfaces.srv.descriptor.ManualMode_Response,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Event': ros_otter_custom_interfaces.srv.descriptor.SetParameters_Event,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Request': ros_otter_custom_interfaces.srv.descriptor.SetParameters_Request,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Response': ros_otter_custom_interfaces.srv.descriptor.SetParameters_Response,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Event': ros_otter_custom_interfaces.srv.descriptor.StationMode_Event,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Request': ros_otter_custom_interfaces.srv.descriptor.StationMode_Request,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Response': ros_otter_custom_interfaces.srv.descriptor.StationMode_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'geographic_msgs/msg/descriptor/BoundingBox': geographic_msgs.msg.descriptor.BoundingBoxConstructor,
    'geographic_msgs/msg/descriptor/GeoPath': geographic_msgs.msg.descriptor.GeoPathConstructor,
    'geographic_msgs/msg/descriptor/GeoPoint': geographic_msgs.msg.descriptor.GeoPointConstructor,
    'geographic_msgs/msg/descriptor/GeoPointStamped': geographic_msgs.msg.descriptor.GeoPointStampedConstructor,
    'geographic_msgs/msg/descriptor/GeoPose': geographic_msgs.msg.descriptor.GeoPoseConstructor,
    'geographic_msgs/msg/descriptor/GeoPoseStamped': geographic_msgs.msg.descriptor.GeoPoseStampedConstructor,
    'geographic_msgs/msg/descriptor/GeoPoseWithCovariance': geographic_msgs.msg.descriptor.GeoPoseWithCovarianceConstructor,
    'geographic_msgs/msg/descriptor/GeoPoseWithCovarianceStamped': geographic_msgs.msg.descriptor.GeoPoseWithCovarianceStampedConstructor,
    'geographic_msgs/msg/descriptor/GeographicMap': geographic_msgs.msg.descriptor.GeographicMapConstructor,
    'geographic_msgs/msg/descriptor/GeographicMapChanges': geographic_msgs.msg.descriptor.GeographicMapChangesConstructor,
    'geographic_msgs/msg/descriptor/KeyValue': geographic_msgs.msg.descriptor.KeyValueConstructor,
    'geographic_msgs/msg/descriptor/MapFeature': geographic_msgs.msg.descriptor.MapFeatureConstructor,
    'geographic_msgs/msg/descriptor/RouteNetwork': geographic_msgs.msg.descriptor.RouteNetworkConstructor,
    'geographic_msgs/msg/descriptor/RoutePath': geographic_msgs.msg.descriptor.RoutePathConstructor,
    'geographic_msgs/msg/descriptor/RouteSegment': geographic_msgs.msg.descriptor.RouteSegmentConstructor,
    'geographic_msgs/msg/descriptor/WayPoint': geographic_msgs.msg.descriptor.WayPointConstructor,
    ...
    'geographic_msgs/srv/descriptor/GetGeoPath_Event': geographic_msgs.srv.descriptor.GetGeoPath_EventConstructor,
    'geographic_msgs/srv/descriptor/GetGeoPath_Request': geographic_msgs.srv.descriptor.GetGeoPath_RequestConstructor,
    'geographic_msgs/srv/descriptor/GetGeoPath_Response': geographic_msgs.srv.descriptor.GetGeoPath_ResponseConstructor,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Event': geographic_msgs.srv.descriptor.GetGeographicMap_EventConstructor,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Request': geographic_msgs.srv.descriptor.GetGeographicMap_RequestConstructor,
    'geographic_msgs/srv/descriptor/GetGeographicMap_Response': geographic_msgs.srv.descriptor.GetGeographicMap_ResponseConstructor,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Event': geographic_msgs.srv.descriptor.GetRoutePlan_EventConstructor,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Request': geographic_msgs.srv.descriptor.GetRoutePlan_RequestConstructor,
    'geographic_msgs/srv/descriptor/GetRoutePlan_Response': geographic_msgs.srv.descriptor.GetRoutePlan_ResponseConstructor,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Event': geographic_msgs.srv.descriptor.UpdateGeographicMap_EventConstructor,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Request': geographic_msgs.srv.descriptor.UpdateGeographicMap_RequestConstructor,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap_Response': geographic_msgs.srv.descriptor.UpdateGeographicMap_ResponseConstructor,
    ...
    'pcl_msgs/srv/UpdateFilename_Event': pcl_msgs.srv.UpdateFilename_EventConstructor,
    ...
    'pcl_msgs/srv/descriptor/UpdateFilename_Event': pcl_msgs.srv.descriptor.UpdateFilename_EventConstructor,
    ...
    'ros_kctrl_custom_interfaces/msg/KctrlDetectedDevices': ros_kctrl_custom_interfaces.msg.KctrlDetectedDevicesConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlDevice': ros_kctrl_custom_interfaces.msg.KctrlDeviceConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlDeviceDisconnected': ros_kctrl_custom_interfaces.msg.KctrlDeviceDisconnectedConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlInfoWarnError': ros_kctrl_custom_interfaces.msg.KctrlInfoWarnErrorConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlMulticast': ros_kctrl_custom_interfaces.msg.KctrlMulticastConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlPUParams': ros_kctrl_custom_interfaces.msg.KctrlPUParamsConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlParameter': ros_kctrl_custom_interfaces.msg.KctrlParameterConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlParameters': ros_kctrl_custom_interfaces.msg.KctrlParametersConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlStatus': ros_kctrl_custom_interfaces.msg.KctrlStatusConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlStatusEntry': ros_kctrl_custom_interfaces.msg.KctrlStatusEntryConstructor,
    'ros_kctrl_custom_interfaces/msg/KctrlVersion': ros_kctrl_custom_interfaces.msg.KctrlVersionConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDetectedDevices': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDetectedDevicesConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDevice': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDeviceConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlDeviceDisconnected': ros_kctrl_custom_interfaces.msg.descriptor.KctrlDeviceDisconnectedConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlInfoWarnError': ros_kctrl_custom_interfaces.msg.descriptor.KctrlInfoWarnErrorConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlMulticast': ros_kctrl_custom_interfaces.msg.descriptor.KctrlMulticastConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlPUParams': ros_kctrl_custom_interfaces.msg.descriptor.KctrlPUParamsConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlParameter': ros_kctrl_custom_interfaces.msg.descriptor.KctrlParameterConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlParameters': ros_kctrl_custom_interfaces.msg.descriptor.KctrlParametersConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlStatus': ros_kctrl_custom_interfaces.msg.descriptor.KctrlStatusConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlStatusEntry': ros_kctrl_custom_interfaces.msg.descriptor.KctrlStatusEntryConstructor,
    'ros_kctrl_custom_interfaces/msg/descriptor/KctrlVersion': ros_kctrl_custom_interfaces.msg.descriptor.KctrlVersionConstructor,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Event': ros_kctrl_custom_interfaces.srv.PUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Request': ros_kctrl_custom_interfaces.srv.PUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/PUParameters_Response': ros_kctrl_custom_interfaces.srv.PUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Event': ros_kctrl_custom_interfaces.srv.RecordingControl_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Request': ros_kctrl_custom_interfaces.srv.RecordingControl_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/RecordingControl_Response': ros_kctrl_custom_interfaces.srv.RecordingControl_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Event': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Request': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders_Response': ros_kctrl_custom_interfaces.srv.RequestDetectedSounders_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Event': ros_kctrl_custom_interfaces.srv.RequestPUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Request': ros_kctrl_custom_interfaces.srv.RequestPUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters_Response': ros_kctrl_custom_interfaces.srv.RequestPUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Event': ros_kctrl_custom_interfaces.srv.SetPUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Request': ros_kctrl_custom_interfaces.srv.SetPUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters_Response': ros_kctrl_custom_interfaces.srv.SetPUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Event': ros_kctrl_custom_interfaces.srv.SounderCommand_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Request': ros_kctrl_custom_interfaces.srv.SounderCommand_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/SounderCommand_Response': ros_kctrl_custom_interfaces.srv.SounderCommand_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Event': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Request': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath_Response': ros_kctrl_custom_interfaces.srv.UpdateRecordingPath_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.PUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Event': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Request': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl_Response': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControl_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Event': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Request': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders_Response': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSounders_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Event': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Request': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters_Response': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParameters_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Event': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Request': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand_Response': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommand_ResponseConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Event': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_EventConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Request': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_RequestConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath_Response': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPath_ResponseConstructor,
    'ros_otter_custom_interfaces/msg/ErrorInfo': ros_otter_custom_interfaces.msg.ErrorInfoConstructor,
    'ros_otter_custom_interfaces/msg/GpsInfo': ros_otter_custom_interfaces.msg.GpsInfoConstructor,
    'ros_otter_custom_interfaces/msg/ImuInfo': ros_otter_custom_interfaces.msg.ImuInfoConstructor,
    'ros_otter_custom_interfaces/msg/Leg': ros_otter_custom_interfaces.msg.LegConstructor,
    'ros_otter_custom_interfaces/msg/ModeInfo': ros_otter_custom_interfaces.msg.ModeInfoConstructor,
    'ros_otter_custom_interfaces/msg/OtterInfo': ros_otter_custom_interfaces.msg.OtterInfoConstructor,
    'ros_otter_custom_interfaces/msg/Paths': ros_otter_custom_interfaces.msg.PathsConstructor,
    'ros_otter_custom_interfaces/msg/ShadowAnalysis': ros_otter_custom_interfaces.msg.ShadowAnalysisConstructor,
    'ros_otter_custom_interfaces/msg/ShadowCell': ros_otter_custom_interfaces.msg.ShadowCellConstructor,
    'ros_otter_custom_interfaces/msg/SurveyInfo': ros_otter_custom_interfaces.msg.SurveyInfoConstructor,
    'ros_otter_custom_interfaces/msg/SwathLineStats': ros_otter_custom_interfaces.msg.SwathLineStatsConstructor,
    'ros_otter_custom_interfaces/msg/Vertex': ros_otter_custom_interfaces.msg.VertexConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/ErrorInfo': ros_otter_custom_interfaces.msg.descriptor.ErrorInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/GpsInfo': ros_otter_custom_interfaces.msg.descriptor.GpsInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/ImuInfo': ros_otter_custom_interfaces.msg.descriptor.ImuInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/Leg': ros_otter_custom_interfaces.msg.descriptor.LegConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/ModeInfo': ros_otter_custom_interfaces.msg.descriptor.ModeInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/OtterInfo': ros_otter_custom_interfaces.msg.descriptor.OtterInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/Paths': ros_otter_custom_interfaces.msg.descriptor.PathsConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/ShadowAnalysis': ros_otter_custom_interfaces.msg.descriptor.ShadowAnalysisConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/ShadowCell': ros_otter_custom_interfaces.msg.descriptor.ShadowCellConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/SurveyInfo': ros_otter_custom_interfaces.msg.descriptor.SurveyInfoConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/SwathLineStats': ros_otter_custom_interfaces.msg.descriptor.SwathLineStatsConstructor,
    'ros_otter_custom_interfaces/msg/descriptor/Vertex': ros_otter_custom_interfaces.msg.descriptor.VertexConstructor,
    'ros_otter_custom_interfaces/srv/CourseMode_Event': ros_otter_custom_interfaces.srv.CourseMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/CourseMode_Request': ros_otter_custom_interfaces.srv.CourseMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/CourseMode_Response': ros_otter_custom_interfaces.srv.CourseMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/DriftMode_Event': ros_otter_custom_interfaces.srv.DriftMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/DriftMode_Request': ros_otter_custom_interfaces.srv.DriftMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/DriftMode_Response': ros_otter_custom_interfaces.srv.DriftMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/LegMode_Event': ros_otter_custom_interfaces.srv.LegMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/LegMode_Request': ros_otter_custom_interfaces.srv.LegMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/LegMode_Response': ros_otter_custom_interfaces.srv.LegMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/ManualMode_Event': ros_otter_custom_interfaces.srv.ManualMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/ManualMode_Request': ros_otter_custom_interfaces.srv.ManualMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/ManualMode_Response': ros_otter_custom_interfaces.srv.ManualMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/SetParameters_Event': ros_otter_custom_interfaces.srv.SetParameters_EventConstructor,
    'ros_otter_custom_interfaces/srv/SetParameters_Request': ros_otter_custom_interfaces.srv.SetParameters_RequestConstructor,
    'ros_otter_custom_interfaces/srv/SetParameters_Response': ros_otter_custom_interfaces.srv.SetParameters_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/StationMode_Event': ros_otter_custom_interfaces.srv.StationMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/StationMode_Request': ros_otter_custom_interfaces.srv.StationMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/StationMode_Response': ros_otter_custom_interfaces.srv.StationMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Event': ros_otter_custom_interfaces.srv.descriptor.CourseMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Request': ros_otter_custom_interfaces.srv.descriptor.CourseMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode_Response': ros_otter_custom_interfaces.srv.descriptor.CourseMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Event': ros_otter_custom_interfaces.srv.descriptor.DriftMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Request': ros_otter_custom_interfaces.srv.descriptor.DriftMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode_Response': ros_otter_custom_interfaces.srv.descriptor.DriftMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Event': ros_otter_custom_interfaces.srv.descriptor.LegMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Request': ros_otter_custom_interfaces.srv.descriptor.LegMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode_Response': ros_otter_custom_interfaces.srv.descriptor.LegMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Event': ros_otter_custom_interfaces.srv.descriptor.ManualMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Request': ros_otter_custom_interfaces.srv.descriptor.ManualMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode_Response': ros_otter_custom_interfaces.srv.descriptor.ManualMode_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Event': ros_otter_custom_interfaces.srv.descriptor.SetParameters_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Request': ros_otter_custom_interfaces.srv.descriptor.SetParameters_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters_Response': ros_otter_custom_interfaces.srv.descriptor.SetParameters_ResponseConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Event': ros_otter_custom_interfaces.srv.descriptor.StationMode_EventConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Request': ros_otter_custom_interfaces.srv.descriptor.StationMode_RequestConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode_Response': ros_otter_custom_interfaces.srv.descriptor.StationMode_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'geographic_msgs/srv/descriptor/GetGeoPath': geographic_msgs.srv.descriptor.GetGeoPathConstructor,
    'geographic_msgs/srv/descriptor/GetGeographicMap': geographic_msgs.srv.descriptor.GetGeographicMapConstructor,
    'geographic_msgs/srv/descriptor/GetRoutePlan': geographic_msgs.srv.descriptor.GetRoutePlanConstructor,
    'geographic_msgs/srv/descriptor/UpdateGeographicMap': geographic_msgs.srv.descriptor.UpdateGeographicMapConstructor,
    ...
    'ros_kctrl_custom_interfaces/srv/PUParameters': ros_kctrl_custom_interfaces.srv.PUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/RecordingControl': ros_kctrl_custom_interfaces.srv.RecordingControlConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestDetectedSounders': ros_kctrl_custom_interfaces.srv.RequestDetectedSoundersConstructor,
    'ros_kctrl_custom_interfaces/srv/RequestPUParameters': ros_kctrl_custom_interfaces.srv.RequestPUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/SetPUParameters': ros_kctrl_custom_interfaces.srv.SetPUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/SounderCommand': ros_kctrl_custom_interfaces.srv.SounderCommandConstructor,
    'ros_kctrl_custom_interfaces/srv/UpdateRecordingPath': ros_kctrl_custom_interfaces.srv.UpdateRecordingPathConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/PUParameters': ros_kctrl_custom_interfaces.srv.descriptor.PUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RecordingControl': ros_kctrl_custom_interfaces.srv.descriptor.RecordingControlConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestDetectedSounders': ros_kctrl_custom_interfaces.srv.descriptor.RequestDetectedSoundersConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/RequestPUParameters': ros_kctrl_custom_interfaces.srv.descriptor.RequestPUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SetPUParameters': ros_kctrl_custom_interfaces.srv.descriptor.SetPUParametersConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/SounderCommand': ros_kctrl_custom_interfaces.srv.descriptor.SounderCommandConstructor,
    'ros_kctrl_custom_interfaces/srv/descriptor/UpdateRecordingPath': ros_kctrl_custom_interfaces.srv.descriptor.UpdateRecordingPathConstructor,
    'ros_otter_custom_interfaces/srv/CourseMode': ros_otter_custom_interfaces.srv.CourseModeConstructor,
    'ros_otter_custom_interfaces/srv/DriftMode': ros_otter_custom_interfaces.srv.DriftModeConstructor,
    'ros_otter_custom_interfaces/srv/LegMode': ros_otter_custom_interfaces.srv.LegModeConstructor,
    'ros_otter_custom_interfaces/srv/ManualMode': ros_otter_custom_interfaces.srv.ManualModeConstructor,
    'ros_otter_custom_interfaces/srv/SetParameters': ros_otter_custom_interfaces.srv.SetParametersConstructor,
    'ros_otter_custom_interfaces/srv/StationMode': ros_otter_custom_interfaces.srv.StationModeConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/CourseMode': ros_otter_custom_interfaces.srv.descriptor.CourseModeConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/DriftMode': ros_otter_custom_interfaces.srv.descriptor.DriftModeConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/LegMode': ros_otter_custom_interfaces.srv.descriptor.LegModeConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/ManualMode': ros_otter_custom_interfaces.srv.descriptor.ManualModeConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/SetParameters': ros_otter_custom_interfaces.srv.descriptor.SetParametersConstructor,
    'ros_otter_custom_interfaces/srv/descriptor/StationMode': ros_otter_custom_interfaces.srv.descriptor.StationModeConstructor,
